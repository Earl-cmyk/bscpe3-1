...
def calculate_simple_interest(data):
    ...
    if solve_for == "future_value":
        result["steps"] = [
            "1. Convert the term to years: " + _format_number(result["time_fraction"]) + " year(s).",
        ...
        result["steps"] = [
            "1. Convert the term to years: " + _format_number(result["time_fraction"]) + " year(s).",
            "2. Use P = A / (1 + r t) = " + _format_number(result["future_value"]) + " / (1 + " + _format_number(result["interest_rate"] / 100) + " x " + _format_number(result["time_fraction"]) + ").",
            "3. Principal invested: " + _format_number(result["principal"]) + ".",
        ]
    else:
        result["steps"] = [
            "1. Convert the term to years: " + _format_number(result["time_fraction"]) + " year(s).",
